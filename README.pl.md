...
`androidclaw onboard` uruchamia się automatycznie po instalacji, aby skonfigurować workspace i dostawcę.
...
androidclaw onboard              # Kreator konfiguracji z przewodnikiem
